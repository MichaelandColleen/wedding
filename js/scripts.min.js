function initMap() {
    var e = { lat: 42.957008180363985, lng: -72.07961108013467 },
...
$(document).ready(function () {
    ...
    var r = createCalendar({
        options: { class: "", id: "" },
        data: {
            title: "Michael and Colleen's Wedding",
            start: new Date("Sept 23, 2022 10:00"),
    ...
    $("#add-to-cal").html(r),
        $("#rsvp-form").on("submit", function (e) {
            ...
            console.log(MD5($("#invite_code").val()), "invite code")
            $("#alert-wrapper").html(alert_markup("info", "<strong>Just a sec!</strong> We are saving your details.")),
                "f35b58668b258021190f862da75d17b9" !== MD5($("#invite_code").val())
                    ? $("#alert-wrapper").html(alert_markup("danger", "<strong>Sorry!</strong> Your invite code is incorrectsdfsdSorry! Your invite code is incorrectasdasd."))
                    : $.post("https://script.google.com/macros/s/AKfycbw1Mv69IFvh2nr8AECmw5-MZZ5sPRDn-de4rrz3vhdjiY5EMnM/exec", t)
                          .done(function (e) {
...
var MD5 = function (e) {
    ...
    for (
        ...
        (f = t((s = f), (p = g), (d = u), (m = h), w[i + 0], 7, 3614090360)),
            ...
            (f = a(f, (g = t(g, u, h, f, w[i + 15], 22, 1236535329)), u, h, w[i + 1], 5, 4129170786)),
            ...
            (f = n(f, (g = a(g, u, h, f, w[i + 12], 20, 2368359562)), u, h, w[i + 5], 4, 4294588738)),
            ...
            (f = o(f, (g = n(g, u, h, f, w[i + 2], 23, 3299628645)), u, h, w[i + 0], 6, 4096336452)),
